    ...
    <div className="flex min-h-[calc(100vh-4rem)] items-center justify-center px-4 py-8">
      <div className="glass-panel flex w-full max-w-md flex-col gap-6 rounded-3xl px-8 py-10">
        <div className="flex flex-col items-center gap-2">
          <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-brand text-lg font-bold shadow-lg">
            CTU
          </div>
        ...
        <div className="space-y-1 text-center text-[11px] text-slate-400">
          ...
          <p className="mt-2">
            ...
            .{" "}
            <Link href="/room-locator" className="font-semibold text-brand-teal hover:underline">
              Room Locator
            </Link>{" "}
            (public)
          </p>
